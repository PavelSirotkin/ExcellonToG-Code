...
| Главный интерфейс | Визуализация слотов | Диалог генерации G-кода |
|:--:|:--:|:--:|
| ![Главный интерфейс](screenshots/main.png) | ![Визуализация слотов](screenshots/slots.png) | ![Диалог генерации G-кода](screenshots/gcode.png) |
