...
![Лицензия](https://img.shields.io/badge/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F-ПНХ-green)
...
| Действие	| Управление |
|-----------|------------|
| Увеличить / уменьшить масштаб	Колесо мыши |
| Переместить вид	| Левый клик + перетаскивание |
| Просмотр координат	| Наведите курсор на рабочую область |
| Показать / скрыть пути	| Чекбокс в настройках |
| Показать / скрыть инструменты	| Чекбоксы в легенде |
